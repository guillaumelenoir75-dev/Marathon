      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:6px;margin-top:2px;">
          ...
          <div style="display:flex;gap:6px;">
            ...
            <button id="whoop-val-btn" onclick="importWhoopForPerfEditExtra(${w},${ei})" style="padding:6px 12px;background:rgba(255,255,255,0.2);border:none;border-radius:20px;color:#fff;font-size:11px;font-weight:700;cursor:pointer;white-space:nowrap;">WHOOP</button>
          </div>
        </div>
      </div>
    </div>
