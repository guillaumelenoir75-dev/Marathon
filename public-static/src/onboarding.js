...
function showOnboarding(editMode){
  ...
  _obData={course:null,date:null,sessions:null,niveau:null,km_semaine:null,generate_plan:null,race_name:null};
...
function _obGoTo(step){
  ...
  if(step===1){
    setTimeout(_obPopulateDateShortcuts,0);
    setTimeout(function(){var el=document.getElementById('ob-race-name');if(el)el.value=_obData.race_name||'';},0);
  }
